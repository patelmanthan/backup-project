...
<body>
    <div class="container">
        ...
        <form class="form validity" action="User_updatee" > 	
         	...
         	<div class="col-lg-12 well" id="header">
               ...
               <div class="form-group">
				...
				<input type="hidden" name="address_id" value="<c:out value="${update.address_id}"/>"/> <%-- value="<c:out value="${(update.address_id eq null)? update.address_id : 'x'}"/>" --%>
				
<%-- 				<input type="hidden" name="user_id" value="<c:out value="${update.user_id}"/>"/>
				<input type="hidden" name="address_id" value="<c:out value="${(update.address_id eq null)? update.address_id : 'x'}"/>"/> --%>
